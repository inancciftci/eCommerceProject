...
const CartItem = ({ product }) => {
  ...
  return (
    <div className="flex gap-[1.5rem] items-center border-[1px] p-[1rem]">
      ...
      <div className="w-[100%] flex justify-between max-md:flex-col">
        <div className=" flex flex-col gap-[1rem] ">
          ...
          <p className="text-slate-400 max-md:text-[1.2rem]">
            <i className="fa-solid fa-truck-fast mr-[0.5rem]"></i>
            Estimated Shipping Time: in 2 days
          </p>
        </div>
        <div className="hidden max-md:flex justify-between items-center pt-[1rem]">
          <div className="flex">
            <button
        ...
        <div className="text-right flex flex-col gap-[0.3rem] max-md:hidden">
          <button
            onClick={() => handleDeleteProduct(product)}
            className="text-[1rem] font-[300] text-slate-400"
          >
